...
const TypingTest = () => {
  ...
  const calculateAccuracy = () => {
    const correctChars = input
      .split("")
      .filter((char, index) => char === sentence[index]);
    const accuracyValue = Math.floor(
      (correctChars.length / input.length) * 100
    );
  ...
  return (
    <div className="typing-test-container">
      ...
      <p className="note">
        <strong>Note:</strong> Your accuracy and typing speed will be displayed
